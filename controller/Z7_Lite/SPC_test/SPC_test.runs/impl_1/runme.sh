...
HD_PWD='C:/Users/Admin/Desktop/FPGA/ZYNQ/Demo/SPC_test/SPC_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPC_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPC_test.tcl -notrace
