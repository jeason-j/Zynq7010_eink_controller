...
HD_PWD='C:/Users/Admin/Desktop/FPGA/ZYNQ/Demo/SPC_test/SPC_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPC_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPC_test.tcl
